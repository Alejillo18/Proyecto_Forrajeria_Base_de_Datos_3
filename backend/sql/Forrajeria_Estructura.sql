...
id_membresia UUID PRIMARY KEY DEFAULT generate_uuidv7(),
...
id_proveedor UUID PRIMARY KEY DEFAULT generate_uuidv7(),
...
id_vendedor UUID PRIMARY KEY DEFAULT generate_uuidv7(),
...
id_cliente UUID PRIMARY KEY DEFAULT generate_uuidv7(),
...
CREATE TABLE ventas(
id_venta UUID PRIMARY  KEY DEFAULT generate_uuidv7(),
...
id_producto UUID PRIMARY KEY DEFAULT generate_uuidv7(),
...
CREATE TABLE envios(
id_envio UUID PRIMARY KEY DEFAULT generate_uuidv7(),
...
id_detalle_venta UUID PRIMARY KEY DEFAULT generate_uuidv7(),
...
CREATE TABLE repartidores(
    id_repartidor UUID PRIMARY KEY DEFAULT generate_uuidv7(),
    nombre_repartidor VARCHAR(50) NOT NULL,
    activo BOOLEAN DEFAULT true
);

ALTER TABLE envios
ADD COLUMN id_repartidor UUID,
ADD CONSTRAINT fk_repartidor 
    FOREIGN KEY (id_repartidor) 
    REFERENCES repartidores(id_repartidor) 
    ON DELETE SET NULL,
ADD COLUMN comision_liquidada BOOLEAN DEFAULT false;